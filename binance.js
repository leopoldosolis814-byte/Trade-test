  ...
  try {
    ...
    if (action === 'optimize') {
      ...
      if (strategy === 'rsi_extremos') {
        ...
        return res.status(400).json({ error: 'Estrategia no válida. Usa: rsi_extremos, ema_cross, bollinger, confluencia' });
      }
      ...
      for (const combo of combos) {
        ...
        if (!mejor || r.retornoTotalPct > mejor.resultado.retornoTotalPct) {
